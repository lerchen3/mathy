...
def process_questions(input_file, output_file):
    ...
    with open(output_file, 'w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(['Question', 'Answer', 'context_vector'])
...
process_questions('possible data sources/obscure_math.csv', 'possible data sources/processed_obscure_math.csv')
