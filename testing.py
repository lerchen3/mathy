...
def batch_conversations_generate(conversations, tokenizer, input_queue1, output_queue1, input_queue2, output_queue2, model='model1') -> list:
    """
...
if __name__ == '__main__':
    ...
    for i in range(6):
        ...
        batch_conversations_generate(
            conversations=[
                [{'role': 'assistant', 
                  'content': 'Each vertex of a regular octagon...'
            ...
            model='model1'  # or 'model2' depending on which model you want to use
        )
        end_time = time.time()
